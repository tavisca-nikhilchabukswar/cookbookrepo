...
default['filebeat_cookbook']['filebeat_directory'] = '~/vagrant/filebeat'
default['filebeat_cookbook']['remote_directory'] = "#{default['filebeat_cookbook']['filebeat_directory']}/filebeat-5.4.3-amd64.deb"
default['filebeat_cookbook']['download_url'] = 'https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-5.4.3-amd64.deb'
default['filebeat_cookbook']['filebeat_source_directory'] = "#{default['filebeat_cookbook']['filebeat_directory']}/filebeat-5.4.3-amd64.deb"
